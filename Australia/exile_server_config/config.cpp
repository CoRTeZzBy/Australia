...
class CfgBuildings
{
	...
	// Australia Loot Positions - Replaced CfgBuildings
	#include "australiaLootBuildings.cpp"
	// Australia Loot Positions - Replaced CfgBuildings
	...
	{
		table = "Military";
		positions[] = {{15.748, 0.212402, 3.87168}, {14.0945, 5.73389, 3.87206}, {12.9875, 3.80908, 3.88764}, {13.7097, 0.234375, 3.88764}, {13.3669, -3.67725, 3.88764}, {3.04492, -3.65234, 3.88764}, {-5.14478, -5.59473, 3.88764}, {-12.2661, -3.30762, 3.88764}, {-12.9519, 0.0800781, 3.88764}, {-13.0081, 3.13086, 3.88764}, {-0.524414, 1.74414, 3.88764}, {6.80005, 3.73047, 3.88764}, {0.539063, -1.99561, 2.18153}, {13.9863, -1.76221, 0.540999}, {2.63794, -3.74268, 0.540999}, {-4.95728, -5.82764, 0.540999}, {-1.50757, -3.89453, 0.540845}, {-11.2444, -1.89014, 0.540999}, {-12.0544, -0.17334, 0.540999}, {-12.5508, 3.85938, 0.540999}, {0.14502, 3.86816, 0.540999}, {6.24072, 1.8916, 0.540999}, {13.345, 3.57471, 0.540999}, {-12.6321, 5.771, 3.87206}, {-11.2849, 1.49805, 7.87136}, {12.2844, -3.05225, 7.75461}};
	};
	class Land_i_Barracks_V1_F
	{
		table = "Military";
...
class CfgSettings
{
	...
	class Respect
	{
		...
		*/
		...
		class Percentages 
		{
			...
			suicide = 4; // Comitting suicide costs you 2% of your respect
			friendyFire = 0; // Friendly fire costs you 3% 
			npc = 0.5; // Being killed by an NPC costs you 4%
			bambiKill = 0; // Killing a bambi costs you 5%
	...
	class Time
	{
		...
		// https://community.bistudio.com/wiki/setDate 2035,7,21,6,0

		staticTime[] = {2039,7,21,9,0};
	};
	...
	class RCON
	{
		...
		*/
		...
		// This needs to match config.cfg serverCommandPassword 96test 96exile2 96exile4 
		serverPassword = "";
	...
	{
		/*
			A list of events that are active  "EarthQuake",
		*/
		enabledEvents[] = {""}; 
		...
		class SupplyBox 
		{
			...
			*/
			...
			dropRadius = 800; // 500m around an airport (including the main airport on Altis!)
